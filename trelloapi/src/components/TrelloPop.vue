...
<div>
    ...
    <div class="inputBoxes">
        ...
        <label> Each card name should be seperated by a comma</label>
...
export default {
   ...
   async postCard(card){
    ...
    const URL_SOURCE = "zaaaaavin.com";
